...
<form id="form1" name="form1" method="post" action="AboutCivil.php" >
  <table width="100%" border="" bgcolor="Cornsilk" style="margin-top:50px;">
    <tr>
      <th scope="row" style="padding:10px; font-size:24px; background-color:DarkOrchid; text-align:center;">About Civil  Depeartment</th>
    </tr>
	
    <tr>
	
      <th scope="row" align="left" height="40%">
       <img src="civil2.jpg" width="1200px" height="700px" style="margin-left:200px; margin-top:10px; color:#FFFFFF;"/>
	   <br> <br>
